...
Q=[1500000 0 0 0   %Penalize Theta
   0 0 0 0         %Penalize Angular velocity
   0 0 0.0004 0    %Penalize Distance covered by cart
   0 0 0 0];       %Penalize Cart Velocity

 R=[0.007];        %Penalize Force Exerted
